/* ------------------
   ...
   ---------------------- */
package com.example.liveTalk.RTSPServer;
import java.io.*;
import java.net.*;
import java.util.*;
import java.text.*;
...
public class Client {
    ...
    class RtcpSender implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int numPktsExpected = statHighSeqNb - lastHighSeqNb;
            // Number of RTP packets lost since the last RTCP packet
            int numPktsLost = statCumLost - lastCumLost;
            // The last fraction lost
            float lastFractionLost = numPktsExpected == 0 ? 0f : (float) numPktsLost / numPktsExpected;
    ...
    private void sendRequest(String request_type) {
        try {
            ...
            if (Objects.equals(request_type, "SETUP")) {
                RTSPBufferedWriter.write("Transport: RTP/UDP; client_port= " + RTP_RCV_PORT + CRLF);
            }
            else if (Objects.equals(request_type, "DESCRIBE")) {
